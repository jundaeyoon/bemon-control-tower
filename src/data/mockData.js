export const projects = [
  ...
  { id: 4, name: '웹사이트 리뉴얼',    status: '진행중', assignee: 'ZIN',    deadline: '2026-08-01', progress: 35 },
  { id: 5, name: 'SNS 캠페인 기획',    status: '진행중', assignee: 'SURI',   deadline: '2026-07-10', progress: 50 },
];

export const schedule = [
  { id: 1, title: '주간 팀 미팅',            date: '2026-06-17', time: '14:00', attendees: ['JUN', 'SURI', 'SUNNY!', 'ZIN'] },
  { id: 2, title: '클라이언트 프레젠테이션', date: '2026-06-20', time: '10:00', attendees: ['JUN', 'ZIN'] },
  { id: 3, title: '브랜딩 워크샵',           date: '2026-06-25', time: '13:00', attendees: ['JUN', 'SURI', 'SUNNY!', 'ZIN'] },
  { id: 4, title: '분기 리뷰',               date: '2026-06-30', time: '15:00', attendees: ['JUN', 'SURI'] },
  { id: 5, title: '파트너 미팅',             date: '2026-07-05', time: '11:00', attendees: ['JUN', 'ZIN'] },
];
...
export const brainstorm = [
  ...
  { id: 4, idea: '팝업스토어 기획',     category: '이벤트',   author: 'ZIN',    votes: 7 },
...
export const goals = [
  ...
  { id: 4, title: '파트너십 체결',      progress: 60, target: '3개사',      current: '1.8개사', owner: 'ZIN' },
];
